...
- FW-0060 rejects 16x16 and 8x8 symmetric INT8 at 1.3479% and 1.1676%
  real-mixture relative L2. All individual experts pass, but fidelity returns
  diminish as F32 scale overhead grows. Test 4x4 once as the last plain-INT8
...
- FW-0069 closes the remaining affine-UINT8 topology frontier. All four
  remaining 65.625%-byte representations fail the six-case gate; 4x4 is closest
  at 1.0505% maximum mixture relative L2, while all experts remain below 2%.
...
- FW-0073 rejects 6% exact groups at 1.020352% worst mixture error, only 2.035
  basis points over the gate, while every expert slice passes. The extra 2% of
  exact groups improves FW-0071's miss by just 0.376 basis points, so advance
